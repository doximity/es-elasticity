...
- Require Elasticsearch Ruby client 8.19
- Send scroll IDs in request bodies for Elasticsearch 9 compatibility

## [1.4.0]
## Changed
- Update dependencies for Rails 8 compatibility
- Replace `ActiveSupport::ProxyObject` with `BasicObject` for Rails 8 compatibility

## [1.3.0] - 2025-02-13
### Changed
- Compatibility elasticsearch-ruby gem v8.16 and beyond
